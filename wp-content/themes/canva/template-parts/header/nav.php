...
$menu_class = \CANVA_THEME\Inc\Menus::get_instance();
$header_menu_id = $menu_class->get_menu_id('canva-header-menu');
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <?php 
                    foreach($child_menu_items as $child_menu_items){
                      ?>
                        <li><a class="dropdown-item" href="<?php echo esc_url($child_menu_items -> url); ?>">
